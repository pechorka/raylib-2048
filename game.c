...
int handle_input(void) {
    ...
    if (IsKeyPressed(KEY_LEFT) || is_button_pressed(leftControlRect))
    {
        move_cells_left();
        merge_cells_left();
        move_cells_left();
    ...
    if (IsKeyPressed(KEY_RIGHT) || is_button_pressed(rightControlRect))
    {
        move_cells_right();
        merge_cells_right();
        move_cells_right();
    ...
    if (IsKeyPressed(KEY_UP) || is_button_pressed(upControlRect))
    {
        transpose_board();
        move_cells_left();
        merge_cells_left();
    ...
    if (IsKeyPressed(KEY_DOWN) || is_button_pressed(downControlRect))
    {
        transpose_board();
        move_cells_right();
        merge_cells_right();
